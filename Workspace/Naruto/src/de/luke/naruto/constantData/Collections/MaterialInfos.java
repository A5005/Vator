...
public class MaterialInfos {
	...
	public static void Create() {
		...
		AddMaterialItem(UniqueIds.NeBrick, Material.NETHER_BRICK_ITEM, 0);
		...
		AddMaterialItem(UniqueIds.Creeper, Material.SULPHUR, 0);
		...
		AddMaterialItem(UniqueIds.Quartz, Material.QUARTZ, 0);
		...
		AddMaterialItem(UniqueIds.Watch, Material.WATCH, 0);

		// EpicMat
		AddMaterialItem(UniqueIds.Ferm, Material.FERMENTED_SPIDER_EYE, 0);
